 ...
 * \param file The file in which the error occurred (used in conjunction with macros).
 * \param line The line number at which the error occurred (used in conjunction with macros).
 */
